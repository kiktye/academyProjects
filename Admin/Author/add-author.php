...
<head>
    ...
    <title>LibraryTok : Add Author</title>
...
<body class="bg-dark">
    ...
    <main class="card-section" style="background-color: #ccc; height: 90vh;">
        <div class="container-fluid">
            ...
            <h1 class="p-5 text-center">Add Author</h1>
            <?php
            ...
            <div class="container" style="width: 40%">
                <form action="./add-authorScript.php" method="POST" id="author-form">
                    ...
                    <div class="formGroup">
                        ...
                        <textarea class="form-control w-100 m-0 text-center fs-5" id="author_biography" name="author_biography" rows="2"></textarea>
                    </div>
            ...
            <hr>
            <div class="group text-center " style="margin-bottom: 200px;">
